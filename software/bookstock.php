...
if(isset($_POST['submit']))
{
	if(isset($_GET['editid']))
	{
		...
		$sql = "UPDATE book_stock SET bookid ='$_POST[bookid]',branchid='$_POST[branchid]',purchasedate='$_POST[purchasedate]',qty='$_POST[qty]',cost='$_POST[racknumber]',status='Active' WHERE book_stock_id='$_GET[editid]'";
	...
	{
		$sql = "INSERT INTO book_stock(bookid,branchid,purchasedate,qty,racknumber,status) VALUES('$_POST[bookid]','$_POST[branchid]','$_POST[purchasedate]','$_POST[qty]','$_POST[racknumber]','Active')";
		$qsql = mysqli_query($con,$sql);
		echo mysqli_error($con);
		if(mysqli_affected_rows($con) ==1)
		{
...
<input type="hidden" class="form-control"  name="bookid"  value="<?php echo $rsbook[0]; ?>">
	...
	<div class="col-md-6 col-sm-12">
			  ...
			  <div class="col-md-12 col-sm-12">
				...
				<label>Rack Number: ₹<?php echo $rsbook['bookcost']; ?></label>
					<br>
...
<br>
	...
	<div class="col-md-6 col-sm-12">
			  <div class="section-title">
				...
				<input type="text" class="form-control" placeholder="Enter Rack number" name="racknumber" id="racknumber"  value="<?php echo $rsedit['racknumber']; ?>" onkeyup="calculatetotalcost()" onchange="calculatetotalcost()">
