...
if(isset($_POST['submit']))
{
	...
	if(isset($_GET['editid']))
	{
		...
		$sql = "UPDATE book SET bookcategoryid ='$_POST[bookcategoryid]',bookname='$_POST[bookname]',bookdescription='$_POST[bookdescription]',bookimg='$filename',bookcost='$_POST[bookcost]',author='$_POST[author]',status='$_POST[status]' WHERE bookid='$_GET[editid]'";
	...
	{
		$sql = "INSERT INTO book(bookcategoryid,bookname,bookdescription,bookimg,bookcost,author,status) VALUES('$_POST[bookcategoryid]','$_POST[bookname]','$_POST[bookdescription]','$filename','$_POST[bookcost]','$_POST[author]','$_POST[status]')";
		$qsql = mysqli_query($con,$sql);
		echo mysqli_error($con);
		if(mysqli_affected_rows($con) ==1)
		{
